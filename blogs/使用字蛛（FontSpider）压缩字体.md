  ...
  <head>
    ...
    <style>
      ...
      @font-face {
        ...
        src: url('./PingFang SC.eot');
        src: url('./PingFang SC.eot?#font-spider') format('embedded-opentype'), url('./PingFang SC.woff') format('woff'), url('./PingFang SC.ttf') format('truetype'),
          url('./PingFang SC.svg') format('svg');
        font-weight: normal;
        font-style: normal;
      }
